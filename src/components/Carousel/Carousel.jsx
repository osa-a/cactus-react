        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h2 className="d-none d-lg-block display-2 text-center m-4">PLANT LOVERS</h2>
              <h3 className="text-center m-5">Nulla vitae elit libero, a pharetra augue mollis interdum.Praesent commodo cursus magna, vel scelerisque nisl consectetur.Praesent commodo cursus magna, vel scelerisque nisl consectetur.</h3>
            </div>
          </div>
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h2 className=" d-none d-lg-blockdisplay-2 text-center m-4">PLANT LOVERS</h2>
              <h3 className="text-center m-5">Nulla vitae elit libero, a pharetra augue mollis interdum.Praesent commodo cursus magna, vel scelerisque nisl consectetur.Praesent commodo cursus magna, vel scelerisque nisl consectetur.</h3>
            </div>
          </div>
        </div>
